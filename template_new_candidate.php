<?php
/* 
Template Name: New candidate page
*/
//get the header
get_header(); 
//start the page loop
...
<section class="about">
	<div class="container">
		<div class="col-sm-6">
			<?php the_content(); ?>		
			<a href="<?php echo get_site_url(); ?>/contact" class="btn">Get support</a>		
		</div>
		<div class="col-sm-6 border-top">
			<img src="<?php echo get_template_directory_uri(); ?>/images/thumbsup.jpg" alt="success">
		</div>
	</div>
</section>
